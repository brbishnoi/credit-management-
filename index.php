...
<div id="header">
       <br>
       <h1 style=" font-family:Agency FB; font-size: 71px  ; "> Sparks Foundation Internship Project </h1>
       <br>
       <h2 style=" font-family:Agency FB; font-size: 59px  ; "> Credit management </h2>
        </div>
        <div id="section">
            <table>
                <tr></tr>
